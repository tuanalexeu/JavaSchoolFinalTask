...
<%--                    </div>--%>
<%--                </div>--%>
<%--                <button class="btn btn-primary btn-block text-white btn-user" onclick="register()" id="register_button" type="submit" style="background: rgb(220,88,184);border-color: #ced8e6;">Register Account</button>--%>
<%--                <hr>--%>
<%--                <hr>--%>
<%--            </form:form>--%>
